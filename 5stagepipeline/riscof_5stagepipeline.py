...
class stagepipeline(pluginTemplate):
    __model__ = "5stagepipeline"
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.dut_exe = os.path.join(config['PATH'] if 'PATH' in config else "","5stagepipeline")
    ...
    def build(self, isa_yaml, platform_yaml):
      ...
      # for 5stagepipeline start building the '--isa' argument. the self.isa is dutnmae specific and may not be
      # useful for all DUTs
