file://<WORKSPACE>/src/main/scala/gcd/SingleCycle/Fetch.scala
### java.lang.AssertionError: assertion failed: position error, parent span does not contain child span
parent      = new InstMem(null: <notype>) # -1,
parent span = <381..623>,
child       = null # -1,
child span  = [393..624..624]

occurred in the presentation compiler.

action parameters:
offset: 405
uri: file://<WORKSPACE>/src/main/scala/gcd/SingleCycle/Fetch.scala
text:
```scala
package SingleCycle
import chisel3._
...
class fetch extends Module{
    ...
    val insMem = Module(new InstMem("<HOME>/@@Desktop/5stagepipeline/src/main/scala/gcd/SingleCycle/imem.txt))
    io.pc_out:= pc
    insMem.io.addr:= pc
